(() => {
    ...
    function t(t, e, n) { this.id = t, this.name = e, this.tasks = n }
    const e = (() => {
    ...
    function n(t, e, n, a, r, o, i, s, d, c) { this.id = t, this.name = e, this.description = n, this.dueDate = a, this.formattedDueDate = r, this.projectId = o, this.priority = i, this.isProjectInbox = s, this.defaultProjectId = d, this.defaultProjectTaskId = c }
    const a = () => {
        ...
        d = (() => {
            const t = () => { const t = document.querySelectorAll(".task-button"); for (let e = 0; e < t.length; e++) t[e].dataset.id = e },
                n = () => {
                    const t = document.querySelectorAll(".task-button");
                    let e = [],
                        n = [];
                    for (const a of t) { const t = a.dataset.defaultProjectId; "null" === t || ("1" !== t ? n = [...n, a] : e = [...e, a]) }
            ...
            return {
                editTaskButton: (t, e, n) => {
                    ...
                    })(r, d) : (t => { document.querySelector(`.task-button[data-id="${t}"] .task-button-description`).remove() })(t), c && !f ? h.innerText = c : null !== c || f || (t => { document.querySelector(`.task-button[data-id="${t}"] .task-button-due-date`).remove() })(t), c && f && ((t, e) => {
                        const n = document.createElement("div"),
                ...
                getTaskButton: e => {
                    ...
                    if (d.classList.add("task-button"), c.classList.add("task-button-top"), u.classList.add("task-button-top-left"), l.classList.add("task-button-top-right"), m.classList.add("task-button-edit-button", "task-button-action-button"), f.classList.add("task-button-checkbox-button-div"), p.classList.add("task-button-checkbox-button"), b.classList.add("task-button-checkbox-icon", "project-icon"), g.classList.add("task-button-task-name"), g.innerText = e.name, d.dataset.projectId = e.projectId, d.dataset.id = e.id, d.dataset.isProjectInbox = e.isProjectInbox, d.dataset.priority = e.priority, d.dataset.defaultProjectId = e.defaultProjectId, d.dataset.defaultProjectTaskId = e.defaultProjectTaskId, f.appendChild(p), p.appendChild(b), u.append(f, g), m.appendChild(h), m.appendChild(h), l.append(m), c.append(u, l), d.append(c), ((t, e) => {
                            e.addEventListener("click", (() => { e.classList.add("clicked") })), e.addEventListener("animationend", (() => {
                                o(t);
                                const e = gt.getSelectedButton();
                                mt.loadEmptyStateIfProjectEmpty(e)
                            }))
                        })(d, p), ((t, e) => { e.addEventListener("click", (() => { lt.addDataAttributesToModal(t), lt.toggleModal(), lt.addEditClass(), lt.disableProjectSelector(), lt.changeSubmitButtonText("Save"), lt.addTaskDataToModal(t), lt.enableSubmitButton() })) })(d, m), n && s) return d;
    ...
    function c(t, e) { if (e.length < t) throw new TypeError(t + " argument" + (t > 1 ? "s" : "") + " required, but only " + e.length + " present") }

    function u(t) { return c(1, arguments), t instanceof Date || "object" == typeof t && "[object Date]" === Object.prototype.toString.call(t) }

    function l(t) { c(1, arguments); var e = Object.prototype.toString.call(t); return t instanceof Date || "object" == typeof t && "[object Date]" === e ? new Date(t.getTime()) : "number" == typeof t || "[object Number]" === e ? new Date(t) : ("string" != typeof t && "[object String]" !== e || "undefined" == typeof console || (console.warn("Starting with v2.0.0-beta.1 date-fns doesn't accept strings as date arguments. Please use `parseISO` to parse strings. See: https://git.io/fjule"), console.warn((new Error).stack)), new Date(NaN)) }

    function m(t) { if (c(1, arguments), !u(t) && "number" != typeof t) return !1; var e = l(t); return !isNaN(Number(e)) }
    var h = { lessThanXSeconds: { one: "less than a second", other: "less than {{count}} seconds" }, xSeconds: { one: "1 second", other: "{{count}} seconds" }, halfAMinute: "half a minute", lessThanXMinutes: { one: "less than a minute", other: "less than {{count}} minutes" }, xMinutes: { one: "1 minute", other: "{{count}} minutes" }, aboutXHours: { one: "about 1 hour", other: "about {{count}} hours" }, xHours: { one: "1 hour", other: "{{count}} hours" }, xDays: { one: "1 day", other: "{{count}} days" }, aboutXWeeks: { one: "about 1 week", other: "about {{count}} weeks" }, xWeeks: { one: "1 week", other: "{{count}} weeks" }, aboutXMonths: { one: "about 1 month", other: "about {{count}} months" }, xMonths: { one: "1 month", other: "{{count}} months" }, aboutXYears: { one: "about 1 year", other: "about {{count}} years" }, xYears: { one: "1 year", other: "{{count}} years" }, overXYears: { one: "over 1 year", other: "over {{count}} years" }, almostXYears: { one: "almost 1 year", other: "almost {{count}} years" } };
    ...
    var f, p = { date: g({ formats: { full: "EEEE, MMMM do, y", long: "MMMM do, y", medium: "MMM d, y", short: "MM/dd/yyyy" }, defaultWidth: "full" }), time: g({ formats: { full: "h:mm:ss a zzzz", long: "h:mm:ss a z", medium: "h:mm:ss a", short: "h:mm a" }, defaultWidth: "full" }), dateTime: g({ formats: { full: "{{date}} 'at' {{time}}", long: "{{date}} 'at' {{time}}", medium: "{{date}}, {{time}}", short: "{{date}}, {{time}}" }, defaultWidth: "full" }) },
        b = { lastWeek: "'last' eeee 'at' p", yesterday: "'yesterday at' p", today: "'today at' p", tomorrow: "'tomorrow at' p", nextWeek: "eeee 'at' p", other: "P" };
    ...
    function w(t) {
        return function(e) {
            ...
            var i, s = o[0],
                ...
                c = Array.isArray(d) ? k(d, (function(t) { return t.test(s) })) : y(d, (function(t) { return t.test(s) }));
    ...
    const S = {
        code: "en-US",
        formatDistance: function(t, e, n) { var a, r = h[t]; return a = "string" == typeof r ? r : 1 === e ? r.one : r.other.replace("{{count}}", e.toString()), null != n && n.addSuffix ? n.comparison && n.comparison > 0 ? "in " + a : a + " ago" : a },
        formatLong: p,
        formatRelative: function(t, e, n, a) { return b[t] },
        localize: {
            ...
            quarter: v({ values: { narrow: ["1", "2", "3", "4"], abbreviated: ["Q1", "Q2", "Q3", "Q4"], wide: ["1st quarter", "2nd quarter", "3rd quarter", "4th quarter"] }, defaultWidth: "wide", argumentCallback: function(t) { return t - 1 } }),
            ...
            dayPeriod: v({ values: { narrow: { am: "a", pm: "p", midnight: "mi", noon: "n", morning: "morning", afternoon: "afternoon", evening: "evening", night: "night" }, abbreviated: { am: "AM", pm: "PM", midnight: "midnight", noon: "noon", morning: "morning", afternoon: "afternoon", evening: "evening", night: "night" }, wide: { am: "a.m.", pm: "p.m.", midnight: "midnight", noon: "noon", morning: "morning", afternoon: "afternoon", evening: "evening", night: "night" } }, defaultWidth: "wide", formattingValues: { narrow: { am: "a", pm: "p", midnight: "mi", noon: "n", morning: "in the morning", afternoon: "in the afternoon", evening: "in the evening", night: "at night" }, abbreviated: { am: "AM", pm: "PM", midnight: "midnight", noon: "noon", morning: "in the morning", afternoon: "in the afternoon", evening: "in the evening", night: "at night" }, wide: { am: "a.m.", pm: "p.m.", midnight: "midnight", noon: "noon", morning: "in the morning", afternoon: "in the afternoon", evening: "in the evening", night: "at night" } }, defaultFormattingWidth: "wide" })
        },
        match: {
            ordinalNumber: (f = { matchPattern: /^(\d+)(th|st|nd|rd)?/i, parsePattern: /\d+/i, valueCallback: function(t) { return parseInt(t, 10) } }, function(t) {
            ...
            era: w({ matchPatterns: { narrow: /^(b|a)/i, abbreviated: /^(b\.?\s?c\.?|b\.?\s?c\.?\s?e\.?|a\.?\s?d\.?|c\.?\s?e\.?)/i, wide: /^(before christ|before common era|anno domini|common era)/i }, defaultMatchWidth: "wide", parsePatterns: { any: [/^b/i, /^(a|c)/i] }, defaultParseWidth: "any" }),
            quarter: w({ matchPatterns: { narrow: /^[1234]/i, abbreviated: /^q[1234]/i, wide: /^[1234](th|st|nd|rd)? quarter/i }, defaultMatchWidth: "wide", parsePatterns: { any: [/1/i, /2/i, /3/i, /4/i] }, defaultParseWidth: "any", valueCallback: function(t) { return t + 1 } }),
            month: w({ matchPatterns: { narrow: /^[jfmasond]/i, abbreviated: /^(jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec)/i, wide: /^(january|february|march|april|may|june|july|august|september|october|november|december)/i }, defaultMatchWidth: "wide", parsePatterns: { narrow: [/^j/i, /^f/i, /^m/i, /^a/i, /^m/i, /^j/i, /^j/i, /^a/i, /^s/i, /^o/i, /^n/i, /^d/i], any: [/^ja/i, /^f/i, /^mar/i, /^ap/i, /^may/i, /^jun/i, /^jul/i, /^au/i, /^s/i, /^o/i, /^n/i, /^d/i] }, defaultParseWidth: "any" }),
            day: w({ matchPatterns: { narrow: /^[smtwf]/i, short: /^(su|mo|tu|we|th|fr|sa)/i, abbreviated: /^(sun|mon|tue|wed|thu|fri|sat)/i, wide: /^(sunday|monday|tuesday|wednesday|thursday|friday|saturday)/i }, defaultMatchWidth: "wide", parsePatterns: { narrow: [/^s/i, /^m/i, /^t/i, /^w/i, /^t/i, /^f/i, /^s/i], any: [/^su/i, /^m/i, /^tu/i, /^w/i, /^th/i, /^f/i, /^sa/i] }, defaultParseWidth: "any" }),
            dayPeriod: w({ matchPatterns: { narrow: /^(a|p|mi|n|(in the|at) (morning|afternoon|evening|night))/i, any: /^([ap]\.?\s?m\.?|midnight|noon|(in the|at) (morning|afternoon|evening|night))/i }, defaultMatchWidth: "any", parsePatterns: { any: { am: /^a/i, pm: /^p/i, midnight: /^mi/i, noon: /^no/i, morning: /morning/i, afternoon: /afternoon/i, evening: /evening/i, night: /night/i } }, defaultParseWidth: "any" })
        },
        options: { weekStartsOn: 0, firstWeekContainsDate: 1 }
    };

    function T(t) { if (null === t || !0 === t || !1 === t) return NaN; var e = Number(t); return isNaN(e) ? e : e < 0 ? Math.ceil(e) : Math.floor(e) }
    ...
    function C(t, e) { c(2, arguments); var n = T(e); return j(t, -n) }
    var P = 864e5;
    ...
    function A(t, e) { for (var n = t < 0 ? "-" : "", a = Math.abs(t).toString(); a.length < e;) a = "0" + a; return n + a }
    const U = function(t, e) {
            var n = t.getUTCFullYear(),
                a = n > 0 ? n : 1 - n;
            return A("yy" === e ? a % 100 : a, e.length)
        },
        O = function(t, e) { var n = t.getUTCMonth(); return "M" === e ? String(n + 1) : A(n + 1, 2) },
        W = function(t, e) { return A(t.getUTCDate(), e.length) },
        B = function(t, e) { return A(t.getUTCHours() % 12 || 12, e.length) },
        Y = function(t, e) { return A(t.getUTCHours(), e.length) },
        z = function(t, e) { return A(t.getUTCMinutes(), e.length) },
        H = function(t, e) { return A(t.getUTCSeconds(), e.length) },
        F = function(t, e) {
            var n = e.length,
    ...
    function Q(t, e) { return t % 60 == 0 ? (t > 0 ? "-" : "+") + A(Math.abs(t) / 60, 2) : J(t, e) }
    ...
    const V = {
        ...
        R: function(t, e) { return A(E(t), e.length) },
        u: function(t, e) { return A(t.getUTCFullYear(), e.length) },
        Q: function(t, e, n) {
        ...
        d: function(t, e, n) { return "do" === e ? n.ordinalNumber(t.getUTCDate(), { unit: "date" }) : W(t, e) },
        D: function(t, e, n) {
            var a = function(t) {
                c(1, arguments);
                var e = l(t),
        ...
        h: function(t, e, n) { if ("ho" === e) { var a = t.getUTCHours() % 12; return 0 === a && (a = 12), n.ordinalNumber(a, { unit: "hour" }) } return B(t, e) },
        H: function(t, e, n) { return "Ho" === e ? n.ordinalNumber(t.getUTCHours(), { unit: "hour" }) : Y(t, e) },
        K: function(t, e, n) { var a = t.getUTCHours() % 12; return "Ko" === e ? n.ordinalNumber(a, { unit: "hour" }) : A(a, e.length) },
        k: function(t, e, n) { var a = t.getUTCHours(); return 0 === a && (a = 24), "ko" === e ? n.ordinalNumber(a, { unit: "hour" }) : A(a, e.length) },
        m: function(t, e, n) { return "mo" === e ? n.ordinalNumber(t.getUTCMinutes(), { unit: "minute" }) : z(t, e) },
        s: function(t, e, n) { return "so" === e ? n.ordinalNumber(t.getUTCSeconds(), { unit: "second" }) : H(t, e) },
        S: function(t, e) { return F(t, e) },
        X: function(t, e, n, a) {
        ...
        t: function(t, e, n, a) { var r = a._originalDate || t; return A(Math.floor(r.getTime() / 1e3), e.length) },
        T: function(t, e, n, a) { return A((a._originalDate || t).getTime(), e.length) }
    };
    ...
    function K(t) { var e = new Date(Date.UTC(t.getFullYear(), t.getMonth(), t.getDate(), t.getHours(), t.getMinutes(), t.getSeconds(), t.getMilliseconds())); return e.setUTCFullYear(t.getFullYear()), t.getTime() - e.getTime() }
    var Z = ["D", "DD"],
        tt = ["YY", "YYYY"];
    ...
    function ct(t, e, n) {
        ...
        var p = K(f),
            b = C(f, p),
            v = { firstWeekContainsDate: d, weekStartsOn: g, locale: o, _originalDate: f },
            w = a.match(ot).map((function(t) { var e = t[0]; return "p" === e || "P" === e ? (0, _[e])(t, o.formatLong, v) : t })).join("").match(rt).map((function(n) { if ("''" === n) return "'"; var a = n[0]; if ("'" === a) return ut(n); var i = V[a]; if (i) return !r.useAdditionalWeekYearTokens && nt(n) && at(n, e, t), !r.useAdditionalDayOfYearTokens && et(n) && at(n, e, t), i(b, n, o.localize, v); if (a.match(dt)) throw new RangeError("Format string contains an unescaped latin alphabet character `" + a + "`"); return n })).join("");
        return w
    }

    function ut(t) { return t.match(it)[1].replace(st, "'") }
    const lt = (() => {
            const t = document.querySelector(".add-task-button"),
                ...
                v = (t, e) => { const n = document.createElement("option"); return n.value = t, n.text = t, n.dataset.id = e, n.classList.add("project-selection-option"), n },
                w = () => {
                ...
                y = () => { h.classList.toggle("visible"), l.classList.toggle("selected") },
                k = () => { for (const t of g) t.classList.remove("active-priority") },
                S = t => {
            ...
            a.addEventListener("transitionend", (() => { b() ? i.focus() : (S(m), T()) })), t.addEventListener("click", (() => P())), f.addEventListener("click", (() => P())), window.addEventListener("keydown", (t => { "Escape" === t.key && b() && P() })), l.addEventListener("click", (() => y())), r.addEventListener("click", (t => {
            ...
            p.addEventListener("click", (() => M())), window.addEventListener("keydown", (t => { "Enter" === t.key && b() && L() && M() }));
            const D = () => { a.classList.remove("editing") },
                I = t => { p.textContent = t };
            return u.addEventListener("input", (() => {
                ...
                addEditClass: () => { a.classList.toggle("editing") },
                addDataAttributesToModal: t => { a.dataset.taskId = t.dataset.id, a.dataset.projectId = t.dataset.projectId, a.dataset.isProjectInbox = t.dataset.isProjectInbox },
                disableProjectSelector: () => { u.disabled = !0 },
                getTaskModalData: x,
                removeEditClass: D,
                ...
                toggleModal: P,
                updateProjectSelectorIds: () => { const t = document.querySelectorAll(".project-selection-option"); for (let e = 0; e < t.length; e++) t[e].dataset.id = e },
        ...
        mt = (() => {
            const t = document.querySelector(".editor"),
                    ...
                    0 === document.querySelectorAll(".task-button").length && (e => {
                        const n = (t => {
                            const e = "true" === t.dataset.isDefaultProject ? t.dataset.tabName : "Project",
                                ...
                                i = document.createElement("p");
                            n.classList.add("empty-state-container"), a.classList.add("empty-state-image"), r.classList.add("empty-state-text"), o.classList.add("empty-state-heading"), i.classList.add("empty-state-body"), a.src = { Inbox: "inbox-empty-state.png", Today: "components/images/today-empty-state.png", Upcoming: "components/images/upcoming-empty-state.png", Project: "project-empty-state.png" }[e];
                            const s = { Inbox: "All clear", Today: "You're all done for the week! #TodoistZero", Upcoming: "Get a clear view of upcoming tasks", Project: "Keep your tasks organized in projects" }[e],
                                d = { Inbox: "Looks like everything's organized in the right place.", Today: "Enjoy the rest of your day.", Upcoming: "All upcoming tasks will show up here.", Project: "Group your tasks by goal or area of your life." }[e];
                ...
                o = (e, n) => {
                    (() => { for (; t.firstChild;) t.removeChild(t.lastChild) })(), gt.changeTabTitle(n), gt.removeSelectedButtonClass(), gt.addSelectedClassToButton(e), (() => {
                        const e = (() => { const t = document.createElement("div"); return t.classList.add("tab-heading"), t })();
                        t.append(e)
                    })(), (t => {
                        const e = document.querySelector(".tab-heading"),
                            n = (t => { const e = document.createElement("h2"); return e.innerText = t, e.classList.add("tab-title"), e })(t);
                        e.append(n)
                    })(n), (() => {
            ...
            return (() => { const t = document.querySelectorAll(".sidebar-button"); for (const e of t) e.addEventListener("click", (() => { o(e, e.dataset.tabName) })) })(), n.addEventListener("click", (() => { o(a, a.dataset.tabName) })), { addSidebarVisibleClass: () => t.classList.add("is-sidebar-visible"), addNewTaskButton: i, changeContent: o, removeSidebarVisibleClass: () => t.classList.remove("is-sidebar-visible"), loadEmptyStateIfProjectEmpty: r }
        })(),
        ht = (() => {
            ...
            return (() => {
                ...
                for (let e = 0; e < n; e++) {
                    const n = t[e].tooltip,
                        a = t[e].parentButton;
                    a.addEventListener("mousedown", (() => { n.classList.remove("visible"), n.classList.contains("clicked") && n.classList.add("clicked") })), a.addEventListener("mouseover", (() => { n.classList.contains("clicked") && n.classList.containes("visible") ? n.classList.remove("visible") : n.classList.add("visible") })), a.addEventListener("mouseout", (() => { n.classList.contains("clicked") && n.classList.remove("clicked"), n.classList.remove("visible") }))
                }
            })(), { changeMenuTooltipTextOpen: () => t.textContent = "Open menu", changeMenuTooltipTextClose: () => t.textContent = "Close menu" }
        })(),
        gt = (() => {
            const t = document.querySelector(".sidebar"),
                ...
                r = () => { t.classList.add("is-visible"), mt.addSidebarVisibleClass(), ht.changeMenuTooltipTextClose() };
            return (() => { const e = document.querySelectorAll(".menu-button"); for (const a of e) a.addEventListener("click", (() => { t.classList.toggle("is-visible"), n.classList.toggle("is-sidebar-visible"), document.querySelector(".sidebar-overlay").classList.toggle("is-visible"), t.classList.contains("is-visible") ? ht.changeMenuTooltipTextClose() : ht.changeMenuTooltipTextOpen() })) })(), (() => {
                const t = document.querySelector(".sidebar-projects-button"),
                    e = document.querySelector(".sidebar-projects-arrow-icon");
                t.addEventListener("click", (() => { e.classList.toggle("expanded"), a.classList.toggle("expanded") }))
            ...
            })), (() => { const t = document.querySelectorAll(".sidebar-button"); for (const e of t) e.addEventListener("click", (() => { d.updateTaskButtonIds(), d.updateTaskButtonDefaultProjectTaskIds() })) })(), {
                changeTabTitle: t => document.title = `${t}: Todoist`,
                addSelectedClassToButton: t => t.classList.add("selected"),
                removeSelectedButtonClass: () => { const t = document.querySelectorAll(".sidebar-button"); for (const e of t) e.classList.contains("selected") && e.classList.remove("selected") },
                ...
                n = t => {
                    ...
                    (t => {
                        const e = document.querySelector("#projects-list"),
                            n = (t => { const e = document.createElement("li"); return e.appendChild(t), e })(t);
                        e.appendChild(n)
                    })(n), (t => {
                        ...
                        t.addEventListener("click", (e => e.target === t && mt.changeContent(e.target, n))), a.addEventListener("click", (() => {
                            ...
                            (t => { t.parentNode.remove() })(t), lt.removeProjectSelectorOption(n), e.removeProject(n), (() => { const t = document.querySelectorAll(".project-button"); for (let e = 0; e < t.length; e++) t[e].dataset.projectId = e })(), lt.updateProjectSelectorIds(), e.updateProjectIds(), e.updateTaskProjectIds()
                        }))
                    })(n)
                };
            return (() => {
    ...
    (() => {
        const n = document.querySelector(".add-project-button"),
            ...
            c = () => s.disabled = !0,
            u = () => { d.classList.toggle("visible"), a.classList.toggle("visible"), r.reset(), c(), o.focus() },
            l = () => {
                const n = o.value,
                    a = e.getNewProjectId(),
                    r = new t(a, n, []);
        ...
        n.addEventListener("mouseup", (() => u())), i.addEventListener("click", (() => u())), o.addEventListener("input", (() => { o.value.replace(/\s/g, "") ? s.disabled = !1 : c() })), s.addEventListener("click", (() => l())), r.addEventListener("submit", (t => { t.preventDefault(), l() }))
    })(), document.querySelector(".reset-data-button").addEventListener("click", (() => { localStorage.clear(), location.reload() }))
})();